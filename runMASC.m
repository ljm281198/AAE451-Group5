...
PerformanceInputs.Vlt  = 95.2;       % loiter velocity [knots] [[change]]
...
BatteryInputs.batP_to       = .1; % portion of battery used in taxi/takeoff
BatteryInputs.batP_cl       = .3; % portion of battery used in climb
