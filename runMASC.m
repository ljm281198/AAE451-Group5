...
PerformanceInputs.PW   = 0.042;      % power-to-weight ratio [lb/hp]
PerformanceInputs.WS   = 30.5;        % wing loading [lbs/ft^2]
...
PerformanceInputs.Vlt  = 127.72;       % loiter velocity [knots] [[change]]
...
BatteryInputs.batP_to       = .5; % portion of battery used in taxi/takeoff
BatteryInputs.batP_cl       = .5; % portion of battery used in climb
