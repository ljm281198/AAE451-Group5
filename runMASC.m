...
PerformanceInputs.PW   = 0.03;      % power-to-weight ratio [lb/hp]
PerformanceInputs.WS   = 25;        % wing loading [lbs/ft^2]
...
PerformanceInputs.Vlt  = 116;       % loiter velocity [knots] [[change]]
